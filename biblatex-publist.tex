...
By default, the year (or pubstate, if no year is given) is positioned in a fixed place
(at the beginning with \joption{plauthorhandling=omit}, after the author list with
\joption{plauthorhandling=highlight}). If you want to place the year at the position determined
by your base style instead, use \joption{fixyear=false}.
...
\begin{description}
	...
	\item [{V. 2.4 (forthcoming):}]~
	\begin{itemize}
		\item New option \joption{fixyear} do opt-out special year handling and positioning.
	\end{itemize}
