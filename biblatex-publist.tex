...
If you want to mark author roles (such as corresponding or main author), this is of course an entry-specific
setting. With \bibltx, you can mark names by using the data annotation feature, as in:
...
will prepend the author family name by a superscripted symbol (the symbols sequence is similar than the
one you now from symbolic footnotes).
