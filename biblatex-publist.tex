...
So in the use case mentioned above, inserting \verb|\setbplnum{1}| before the first section that lists
...
all publication-related sections in a \jenviron{bplnumgroup} environment and and all conference-paper-related
