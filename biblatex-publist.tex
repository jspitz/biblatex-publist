...
since otherwise they would be too ambiguous.

Please note that both \jcsmacro{citeitem} and \jcsmacro{citesecitem} are only available if you use the citestyle provided
by \bpl. And of course they presuppose that you do not disable numbering.
...
\begin{description}
	...
	\begin{itemize}
		\item Add \jcsmacro{citesecitem} command (see sec.~\ref{sec:standard-usage}).
	\end{itemize}
