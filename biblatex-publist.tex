...
number of entries back to 1. This works with \joption{plnumbered=reset} as well.
Note, however, that the numbering might go wrong with complex filtering and nested bibliography sections.
...
\begin{description}
	...
	\begin{itemize}
		\item Add option \jfoption{reversenumbering}.
