...
If the option \joption{plauthorhandling=hilight} has been selected, \bpl\ will consider all \jcsmacro{plauthorname}
...
entries authored by \emph{any} of the specified persons with \joption{plauthorhandling=hilight}.
