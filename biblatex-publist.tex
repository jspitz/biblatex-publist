...
\date{Version 2.3dev, 2023/03/13}
\maketitle
...
\begin{description}
	...
	\item [{V. 2.3 (forthcoming):}]~
	\begin{itemize}
		\item Change of sorting (via \joption{plsorting} or \joption{plauthorhandling})
		      via \jcsmacro{ExecutePublistOptions} now works for all subsequent refsections.
	\end{itemize}
