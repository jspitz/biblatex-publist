...
\begin{itemize}
	...
	\item With \joption{plauthorhandling}, \bpl\ uses different sorting schemes for \joption{omit} (\texttt{ydt})
	      ...
	      So changing this option within a document might reset sorting you have set yourself via \bibltx's
	      \jfoption{sorting} option.
	      You can change that back via \jfcsmacro{newrefcontext[sorting=<sorting>]}.
\end{itemize}
