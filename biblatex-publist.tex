...
\begin{itemize}
	...
	\item Add information about peer review process
...
It is common, and sometimes mandatory, to add information to publication list entries about if
and how work has been subject to peer review.
To this end, \bpl\ provides a specific database field, \texttt{peerreview}, which can have the following values:
...
\begin{description}\setlength{\itemsep}{0pt}
	...
	\item{\texttt{none}} (no peer review)
\end{description}
%
...
\item \emph{peerreview:none}: the phrase ``no peer review''.
\end{itemize}
...
\begin{description}
	...
	\item [{V. 1.26 (forthcoming):}]~
	\begin{itemize}
		\item Provide meands to add peer review information (see section~\ref{sec:peerreview}).
