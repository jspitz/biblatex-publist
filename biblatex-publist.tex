...
\date{Version 1.21dev, forthcoming}
\maketitle
...
If you want to refer to an item number, use \jcsmacro*{citeitem}\jmacro{\{<key>\}}. This will consider
all numbering tweaks you make via the \bpl\ options.
...
It takes a positive or negative integer value that determines the shifting
(e.\,g., \verb|\shiftpblnum{2}| or \verb|\shiftbplnum{-1}|). This can be used anywhere and applies
to all subsequent items.
For the numbering output by \jfmacro{citeitem}, shifting can be done, analogously. by
\jcsmacro*{citeitemshift}.
...
\begin{description}
	...
	\begin{itemize}
		...
		\item Add \jcsmacro{shiftbplnum} and \jcsmacro{citeitemshift} helper macros
