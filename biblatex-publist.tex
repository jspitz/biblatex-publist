...
section that follows to a specific value, which is passed as argument. All following numbers ascend or descend
from the new value. This happens across bibliography sections with continuous numbering, i.\,e., if
\joption{plnumber=reset} is not used.
