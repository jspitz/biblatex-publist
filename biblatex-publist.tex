...
you need to do this per entry, as such roles differ between publications.
With \bibltx, you can mark up individual names by using the data annotation feature, as in:
