...
\date{Version 1.18dev, 2020/07/31}
\maketitle
...
However, it works a bit differently than normal truncation, since the publication list author(s) has\slash have to be taken care of specifically.
...
author name is not counted here). If the treshold is reached, \emph{et al.} (or the localized string) is appended (and the list truncated
