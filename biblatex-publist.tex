...
which helps to produce a publication list with Bib\TeX.
The \bpl\ package started off as the attempt of emulating the features of
\emph{publist.bst} with \bibltx's means; it thus partly draws on
Markey's conceptual ideas. Meanwhile, however, it has significantly exceeded
