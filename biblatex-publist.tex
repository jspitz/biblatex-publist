...
but you do not want to clutter the author data themselves.
...
annotations. Otherwise they are just ignored.
...
Note that the annotation feature only works, since it also only makes sense, with
\joption{plauthorhandling=highlight}.
