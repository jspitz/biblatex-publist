...
If you need to adjust the numbering manually, you can do so with the macro \jcsmacro*{shiftbplnum}.
...
\begin{description}
	...
	\begin{itemize}
		...
		\item Add \jcsmacro{shiftbplnum} helper macro. See sec.~\ref{sec:auxmacros}.
