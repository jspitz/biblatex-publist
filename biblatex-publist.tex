...
\date{Version 1.25dev, 2021/12/11}
\maketitle
...
\begin{description}
	...
	\item [{V. 1.25 (forthcoming):}]~
	\begin{itemize}
		\item More robustification with names with non-ASCII chars.
		\item With \joption{pubstateextra}, consider different pubstates.
	\end{itemize}
