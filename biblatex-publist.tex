...
\subsection{Marking OpenAccess Publications}\label{sec:openaccess}
...
\item \emph{openaccess:true}: the expression ``OpenAccess''.
\item \emph{openaccess:gold}: the phrase ``OpenAccess (gold)''.
\item \emph{openaccess:green}: the phrase ``OpenAccess (green)''.
