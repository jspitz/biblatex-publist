...
\date{Version 1.3dev, 2016/08/06}
\maketitle
...
\jmacro*{extralabel\-numberwidth} via \jfcsmacro{setlength} (default is 0pt).
...
\begin{itemize}
	...
	\item Sorting and extrayear label assignment is more consistent.
