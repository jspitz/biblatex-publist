...
you should also specify the section the item is in, as in: ``see [13] (sec.~4)''.
...
\jcsmacro*{citesecitem*}\jmacro{\{<key>\}} which will append a reference to the section the item is in.
By default, the form of this addition is ``(sec.~<no.>)'', with ``sec.'' being localized.
You can change this by redefining the macro:
